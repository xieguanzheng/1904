...
<form class="form-horizontal" action="{{url('goodss/upd'.$data->shop_id)}}" method="post" role="form" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label for="firstname" class="col-sm-2 control-label">商品名称</label>
        <div class="col-sm-3">
            <input type="text" name="shop_name" class="form-control" id="firstname" placeholder="请输入名称" value="{{$data->shop_name}}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" name="shop_price" class="form-control" id="firstname" placeholder="请输入价格" value="{{$data->shop_price}}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            ...
            <img src="{{env('UPLOAD_URL')}}{{$data->shop_img}}" width="50" height="50">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" name="shop_num" class="form-control" id="firstname" placeholder="请输入库存" value="{{$data->shop_num}}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="radio" name="is_new"  value="1" id="firstname" @if($data->is_new==1)checked @endif>是
            <input type="radio" name="is_new"  value="2" id="firstname" @if($data->is_new==2)checked @endif>否
        </div>
    </div>
    <div class="form-group">
        <label for="firstname" class="col-sm-2 control-label">是否热卖</label>
        <div class="col-sm-3">
            <input type="radio" name="is_hot"  value="1" id="firstname" @if($data->is_hot==1)checked @endif>是
            <input type="radio" name="is_hot"  value="2" id="firstname" @if($data->is_hot==2)checked @endif>否
        </div>
    </div>
    <div class="form-group">
        <label for="lastname" class="col-sm-2 control-label">商品详情</label>
        <div class="col-sm-10">
            <textarea name="shop_account" id="" cols="20" rows="6">{{$data->shop_account}}</textarea>
        </div>
    </div>
    <div class="form-group">
